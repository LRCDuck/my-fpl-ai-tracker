...
# --- SIDEBAR CONFIGURATION (ADDING USER MANAGER ID INPUT) ---
...
# --- 1. GLOBAL DATABASE MAP FETCH (ELIMINATES HARDCODED NAMES COMPLETELY) ---
...
with tab1:
    ...
    if selected_entry_id and selected_entry_id != 123456:
        try:
            ...
            # Tonight at 19:00 UK this automatically drops event/1 history and unmasks locked event/2 team sheets!
    ...
    # --- RENDERING THE PITCH (IF SERVER TIMED OUT, SHOW EMPTY SANITY FIELD) ---
    if not gkp:
